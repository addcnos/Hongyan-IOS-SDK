...
@implementation SRHouseContentCell
...
- (void)setCellViewModel:(SRHouseContentCellViewModel *)cellViewModel {
    _cellViewModel = cellViewModel;
    SRHouseContent *houseContent = (SRHouseContent *)cellViewModel.chatModel.content;
    ...
    [self.coverView sd_setImageWithURL:[NSURL URLWithString:houseContent.icon]];
    self.title.text = houseContent.title;
    self.address.text = houseContent.address;
    self.price.text = houseContent.price;
    self.price_unit.text = houseContent.price_unit;
