...
////! Project version number for SRIM.
//FOUNDATION_EXPORT double SRIMVersionNumber;
//
////! Project version string for SRIM.
//FOUNDATION_EXPORT const unsigned char SRIMVersionString[];
//
