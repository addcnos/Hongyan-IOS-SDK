...
- (void)viewDidLoad {
    ...
    houseModel.icon = @"https://www.debug.example.com/Public/Static/images/rongcloud_default2.png";
    houseModel.is_refresh = 0;
    houseModel.linkUrl = @"https://www.debug.example.com/rent-detail-686524.html?z=1_4_1_1";
    houseModel.note = @"";
